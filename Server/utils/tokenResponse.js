...
const createToken = (_id, _email, _user, _role, _profile_id, _avatar) => {
    let newToken = jwt.sign({ _id: _id, user: _user, email: _email, role: _role, profile_id: _profile_id, avatar: _avatar }, `${TOKEN}`, { expiresIn: "30d" });
